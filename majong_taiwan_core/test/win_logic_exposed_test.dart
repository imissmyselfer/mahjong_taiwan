...
void main() {
  group('WinLogic with exposed melts', () {
    ...
    test('1 組暗槓：手 13 張 + 1 槓（4 張）= 17 張可胡', () {
      // 已暗槓：11
      // 手：22,23,24 + 33,33,33 + 41,41,41 + 51,51,51 + 19,19 = 14 張
      // 注意：槓佔 4 張但算 1 個面子，所以 concealed 還是 14 張（因為槓後補嶺上牌）
      final concealed = [22, 23, 24, 33, 33, 33, 41, 41, 41, 51, 51, 51, 19, 19];
      final melts = [
    ...
    test('isWinning（純 17 張）對有吃碰槓的玩家會誤判', () {
      // 提醒：isWinning 不接受 melts，有吃碰槓的玩家手 < 17 張會直接失敗
      // 這是已知設計限制，列為文件性 test
